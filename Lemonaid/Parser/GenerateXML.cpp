...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	bool
	GenerateXML::CreateOutputTree(bool BuildClient, bool BuildServer)
	{
		bool	Results = true;
		...
		_TopDir = Global::OutputDirectory + "/" + XML_s;
	...
	bool
	GenerateXML::CreateClientSideCode() const
	{
		/**@todo*/
		return(false);
	}
	...
	bool
	GenerateXML::CreateServerSideCode() const
	{
		/**@todo*/
		return(false);
	}
	...
	std::string
	GenerateXML::DeclareVariablType(Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateXML::DeclareVariable(Symbol * S) const
	{
		std::string Results;
	...
	bool
	GenerateXML::WriteHeaders() const
	{
		bool Results = false;
	...
	bool
	GenerateXML::WriteDocuments() const
	{
		bool Results = false;
	...
	std::string
	GenerateXML::to_string(Symbol::Array_e A) const
	{
		std::string Results;
	...
	std::string
	GenerateXML::to_string(Symbol::Visibility_e V) const
	{
		std::string Results;
	...
	std::string
	GenerateXML::SymbolType(Symbol * S) const
	{
	...
	std::string
	GenerateXML::SymbolMethod(Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateXML::RangeComment(const Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateXML::DefaultComment(const Symbol * S) const
	{
		std::string Results;
