...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	bool
	GenerateXML::CreateClientSideCode()
	{
		/**@todo*/
		return(false);
	}
	...
	bool
	GenerateXML::CreateServerSideCode()
	{
		/**@todo*/
		return(false);
	}
	...
	bool
	GenerateXML::DeclareVariablType(Symbol * S)
	{
		bool Results = false;
	...
	bool
	GenerateXML::DeclareVariable(Symbol * S)
	{
		bool Results = false;
