 ...
 */
#ifndef __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATENATIVE_HPP__
#define __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATENATIVE_HPP__
...
namespace RiverExplorer::Phoenix::Protocol
{
	 ...
	 * data types (int, float, ...) without interpertation.
	 */
	class GenerateNATIVE
		: public Generate
		
	{
	public:

		virtual ~GenerateNATIVE() {};
		 ...
		 *
		 * This method checks the target languge(s).
		 *
		 * @note
...
#endif // __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATENATIVE_HPP__
