...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	bool
	GenerateCBOR::CreateOutputTree(bool BuildClient, bool BuildServer)
	{
		bool	Results = true;
		...
		_TopDir = Global::OutputDirectory + "/" + CBOR_s;
