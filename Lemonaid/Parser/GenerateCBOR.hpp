 ...
 */
#ifndef __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATECBOR_HPP__
#define __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATECBOR_HPP__
...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	public:
		...
		virtual ~GenerateCBOR() {};

		/**
		 * Generate the cbor code.
		 *
		 */
...
#endif // __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATECBOR_HPP__
