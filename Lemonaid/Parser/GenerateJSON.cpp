...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	bool
	GenerateJSON::CreateOutputTree(bool BuildClient, bool BuildServer)
	{
		bool	Results = true;
		...
		_TopDir = Global::OutputDirectory + "/" + JSON_s;
	...
	bool
	GenerateJSON::CreateClientSideCode() const
	{
		/**@todo*/
		return(false);
	}
	...
	bool
	GenerateJSON::CreateServerSideCode() const
	{
		/**@todo*/
		return(false);
	}
	...
	std::string
	GenerateJSON::DeclareVariablType(Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateJSON::DeclareVariable(Symbol * S) const
	{
		std::string Results;
	...
	bool
	GenerateJSON::WriteHeaders() const
	{
		bool Results = false;
	...
	bool
	GenerateJSON::WriteDocuments() const
	{
		bool Results = false;
	...
	std::string
	GenerateJSON::to_string(Symbol::Array_e A) const
	{
		std::string Results;
	...
	std::string
	GenerateJSON::to_string(Symbol::Visibility_e V) const
	{
		std::string Results;
	...
	std::string
	GenerateJSON::SymbolType(Symbol * S) const
	{
	...
	std::string
	GenerateJSON::SymbolMethod(Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateJSON::RangeComment(const Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateJSON::DefaultComment(const Symbol * S) const
	{
		std::string Results;
