...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	bool
	GenerateJSON::CreateClientSideCode()
	{
		/**@todo*/
		return(false);
	}
	...
	bool
	GenerateJSON::CreateServerSideCode()
	{
		/**@todo*/
		return(false);
	}
	...
	bool
	GenerateJSON::DeclareVariablType(Symbol * S)
	{
		bool Results = false;
	...
	bool
	GenerateJSON::DeclareVariable(Symbol * S)
	{
		bool Results = false;
