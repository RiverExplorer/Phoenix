...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	bool
	GenerateREST::CreateClientSideCode() const
	{
		/**@todo*/
		return(false);
	}
	...
	bool
	GenerateREST::CreateServerSideCode() const
	{
		/**@todo*/
		return(false);
	}
	...
	std::string
	GenerateREST::DeclareVariablType(Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateREST::DeclareVariable(Symbol * S) const
	{
		std::string Results;
	...
	bool
	GenerateREST::WriteHeaders() const
	{
		bool Results = false;
	...
	bool
	GenerateREST::WriteDocuments() const
	{
		bool Results = false;
	...
	std::string
	GenerateREST::to_string(Symbol::Array_e A) const
	{
		std::string Results;
	...
	std::string
	GenerateREST::to_string(Symbol::Visibility_e V) const
	{
		std::string Results;
	...
	std::string
	GenerateREST::SymbolType(Symbol * S) const
	{
	...
	std::string
	GenerateREST::SymbolMethod(Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateREST::RangeComment(const Symbol * S) const
	{
		std::string Results;
	...
	std::string
	GenerateREST::DefaultComment(const Symbol * S) const
	{
		std::string Results;
