 ...
 */
#ifndef __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATEREST_HPP__
#define __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATEREST_HPP__
...
namespace RiverExplorer::Phoenix::Protocol
{
	...
	public:
		...
		virtual ~GenerateREST() {};

		/**
		 * Generate the rest code.
		 *
		 */
...
#endif // __RIVEREXPLORER_PHOENIX_PROTOCOL_GENERATEREST_HPP__
